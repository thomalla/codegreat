...
public class Path
{
    public static class Web
    {
        ...
        public static final String TEST15 = "/test/1/5";
        public static final String TEST16 = "/test/1/6";

        public static final String TEST21 = "/test/2/1";
        ...
        public static final String TEST33 = "/test/3/3";
        public static final String TEST34 = "/test/3/4";
    ...
    public static class Template
    {
        ...
        public static final String DESCRIPTION1 = "html/course/description1.html";
        public static final String DESCRIPTION2 = "html/course/description2.html";
        public static final String DESCRIPTION3 = "html/course/description3.html";
